  ...
  <div>
    ...
    <ul class="nav user-menu pull-right" style="position: fixed; top: 0; right: 0;">
      ...
      <li class="nav-item dropdown has-arrow">
        <a title="Logout" class="dropdown-item mr-3 ml-3 pr-3" @click.prevent="attemptLoggingOutUser" style="cursor: pointer;"><i class="fas fa-sign-out-alt"></i></a>
      </li>
    </ul>
    <div class="dropdown mobile-user-menu pull-right mr-3">
        <a title="Logout" class="dropdown-item mr-3 ml-3" @click.prevent="attemptLoggingOutUser" style="cursor: pointer;"><i class="fas fa-sign-out-alt"></i></a>
    </div>
  </div>
</template>
...
<script>
  ...
  import { MANAGER, TAILOR, LAUNDRY, FRONT_DESK, ATTEMPT_LOGOUT } from "../../store/store_helpers/constantVariables";
