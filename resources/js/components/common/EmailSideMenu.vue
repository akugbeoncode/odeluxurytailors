  ...
  <div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
      <ul>
        ...
        <li :class="{ active: activeLinkLabel  === 'email inbox' }">
          <router-link
            :to="{
              name: 'OLTsEmailInboxEmails',
              params: {
                loggedUserID: loggedUserID
              }
            }"
          >
            Inbox <span class="mail-count">({{ inboxLength }})</span>
          </router-link>
        </li>

        <li :class="{ active: activeLinkLabel  === 'starred email' }">
          <router-link
            :to="{
              name: 'OLTsEmailStarredEmails',
              params: {
                loggedUserID: loggedUserID
              }
            }"
        ...
        <li :class="{ active: activeLinkLabel  === 'sent email' }">
          <router-link
            :to="{
              name: 'OLTsEmailSentEmails',
              params: {
                loggedUserID: loggedUserID
              }
            }"
        ...
        <li :class="{ active: activeLinkLabel  === 'trashed email' }">
          <router-link
            :to="{
              name: 'OLTsEmailTrashEmails',
              params: {
                loggedUserID: loggedUserID
              }
            }"
        ...
        <li :class="{ active: activeLinkLabel  === 'email draft' }">
          <router-link
            :to="{
              name: 'OLTsEmailDraftEmails',
              params: {
                loggedUserID: loggedUserID
              }
            }"
          >
            Draft <span class="mail-count">({{draftLength}})</span>
          </router-link>
        </li>
      </ul>
    </div>
