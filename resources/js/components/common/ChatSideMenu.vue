    ...
    <div id="sidebar-menu" class="sidebar-menu">
      <ul>
        <li class="d-flex justify-content-center">
          <router-link
            :to="loggedUserDashboard"
            class="pt-3 pb-3"
          >
            <i class="fas fa-house-user"></i> Back to Home
          </router-link>
        </li>
        ...
        <li>
            <a href="chat.html"><span class="chat-avatar-sm user-img"><img :src="photo" alt="" class="rounded-circle"><span class="status online"></span></span> John Doe <span class="badge badge-pill bg-danger pull-right">1</span></a>
        </li>
        <li>
            <a href="chat.html"><span class="chat-avatar-sm user-img"><img :src="photo" alt="" class="rounded-circle"><span class="status offline"></span></span> Richard Miles <span class="badge badge-pill bg-danger pull-right">18</span></a>
        </li>
        <li>
            <a href="chat.html"><span class="chat-avatar-sm user-img"><img :src="photo" alt="" class="rounded-circle"><span class="status away"></span></span> John Smith</a>
        </li>
        <li>
            <a href="chat.html"><span class="chat-avatar-sm user-img"><img :src="photo" alt="" class="rounded-circle"><span class="status online"></span></span> Mike Litorus <span class="badge badge-pill bg-danger pull-right">108</span></a>
        </li>
      </ul>
    </div>
  </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      console.log(this.loggedUserDashboard)
    },
