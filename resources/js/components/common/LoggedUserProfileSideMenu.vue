  ...
  <div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
      <ul>
        ...
        <li :class="{ active: activeLinkLabel  === 'logged user profile' }">
          <router-link
            :to="{
        ...
        <li :class="{ active: activeLinkLabel  === 'edit logged user profile' }">
            <router-link
              :to="{
          ...
          <li :class="{ active: activeLinkLabel  === 'change logged user photo' }">
            <router-link
              :to="{
          ...
          <li :class="{ active: activeLinkLabel  === 'change logged user password' }">
            <router-link
              :to="{
