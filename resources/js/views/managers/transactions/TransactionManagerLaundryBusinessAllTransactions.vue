  ...
  <div class="content container-fluid">
    <div class="row">
        <div class="col-sm-4 col-4">
            <h4 class="page-title">OLTs Laundry Services Transactions</h4>
        </div>
        <div class="col-sm-8 col-8 text-right m-b-30">
          <router-link 
            :to="{
              name: 'TransactionManagerRegisterNewLaundryTransaction',
              params: {
...
<script>
  ...
  export default {
    name: 'TransactionManagerLaundryBusinessAllTransactions',
    ...
    created() {
      EventBus.$emit('active-menu-label-updated', 'laundry business transactions');
    }
  }
</script>
