  ...
  <div class="content container-fluid">
    <div class="row">
        <div class="col-sm-4 col-4">
            <h4 class="page-title">Edit Product Unit</h4>
        </div>
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="form-group">
                  ...
                  <input type="text" @input="clearErrorStatusOnInput('name')" class="form-control" v-model="productUnit.name">
                </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                  ...
                  <input type="text" @input="clearErrorStatusOnInput('code')" class="form-control" v-model="productUnit.code">
                </div>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="form-group">
                  ...
                  <input type="number" @input="clearErrorStatusOnInput('base_unit')" class="form-control" v-model="productUnit.base_unit">
                </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group">
                  ...
                  <select @input="clearErrorStatusOnInput('operator')" class="select form-control floating focused" v-model="productUnit.operator">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="form-group">
                  ...
                  <input type="number" @input="clearErrorStatusOnInput('operational_value')" class="form-control" v-model="productUnit.operational_value">
                </div>
            ...
            <div class="col-md-6 mt-5">
              <div class="form-group form-focus focused">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="checkbox" v-model="productUnit.is_active"> Enable Brand
                    </label>
                </div>                    
              </div>
            </div>
            <div class="col-md-12 mb-3">
              <div class="form-group">
                  ...
                  <textarea @input="clearErrorStatusOnInput('description')" class="form-control" v-model="productUnit.description"></textarea>
                </div>
        ...
        <div class="text-center m-t-20">
          <button v-if="!isLoading" @click.prevent="attemptUpdatingProductUnit" class="btn btn-primary btn-lg" type="button">Update Record</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      attemptUpdatingProductUnit() {
        this.$store.dispatch(IS_LOADING, true)
          .then(() => { 
            let formData = new FormData();
            let contentType = 'application/json';

            formData.append('name', this.productUnit.name);
            formData.append('code', this.productUnit.code);
            formData.append('base_unit', this.productUnit.base_unit);
            formData.append('operator', this.productUnit.operator);
            formData.append('operational_value', this.productUnit.operational_value);
            formData.append('is_active', this.productUnit.is_active);
            formData.append('description', this.productUnit.description);

            formData.append('content_type', contentType);
            formData.append("_method", "put");

            axios.defaults.headers.common['Authorization'] =  `${this.tokenType} ${this.token}`;
            axios.post(`/managers/units/${this.productUnit.id}`, formData, {
              headers: {
      ...
      clearErrorStatusOnInput(fieldName) {
        if (this.productUnit[fieldName].length > 0) {
          this.errors[fieldName] = []
        }
        this.errorMessage = ""
      },

      async getProductUnitFromBackendService() {
        let response = null;
    ...
    created() {
      ...
      EventBus.$emit('active-menu-label-updated', 'edit unit');

      this.unitID = this.$route.params.unitID

      this.$store.dispatch(IS_LOADING, true)
        .then(async () => { 
          this.productUnit = await this.getProductUnitFromBackendService();
          this.$store.dispatch(IS_LOADING, false)
            .then(() => {  
              console.log(`isLoading false === ${this.isLoading}`); 
            }).catch((error) => { console.log(`IS LOADING LOGIN ERROR: ${error}`); });
