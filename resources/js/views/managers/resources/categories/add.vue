    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="profile-img-wrap">
                <img class="inline-block" :src="form.categoryImage ? form.categoryImage : imageURL" alt="Category Image">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                    <div class="form-group form-focus select-focus">
                      ...
                      <select @input="clearErrorStatusOnInput('parent_id')" class="select form-control floating focused" v-model="form.parent_id">
            ...
            <div class="col-md-12 mb-3">
              <div class="form-group">
                  ...
                  <textarea @input="clearErrorStatusOnInput('meta_name')" class="form-control" v-model="form.meta_name"></textarea>
                </div>
        ...
        <div class="text-center m-t-20">
          <button v-if="!isLoading" @click.prevent="attemptAddingCategory" class="btn btn-primary btn-lg" type="button">Add Category</button>
...
<script>
  ...
  export default {
      ...
      attemptAddingCategory() {
        this.$store.dispatch(IS_LOADING, true)
          .then(() => { 
            ...
            formData.append('meta_name', this.form.meta_name);
            ...
            axios.post('/managers/categories', formData, {
              headers: {
    ...
    created() {
      EventBus.$emit('active-menu-label-updated', 'add category');

      this.$store.dispatch(IS_LOADING, true)
        .then(()=>{
            axios.defaults.headers.common['Authorization'] =  `${this.tokenType} ${this.token}`;
            axios.get('/category-resources')
            .then(response => {
              if (response.status === 200) {
