    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="profile-img-wrap">
                <img class="inline-block" :src="brand.image" alt="Brand Logo">
                ...
                <div class="row">
                  <div class="col-md-12 mb-4 mt-3">
                    <div class="form-group form-focus focused">
                      ...
                      <input @keypress="isLetter($event)" @input="clearErrorStatusOnInput('name')" type="text" class="form-control floating text-center" v-model="brand.name">
                    </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group form-focus focused">
                      <div class="checkbox">
                          <label>
                              <input type="checkbox" name="checkbox" v-model="brand.is_active"> Enable Brand
                          </label>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-12 mb-3">
              <div class="form-group">
                  ...
                  <textarea @input="clearErrorStatusOnInput('description')" class="form-control" v-model="brand.description"></textarea>
                </div>
        ...
        <div class="text-center m-t-20">
          <button v-if="!isLoading" @click.prevent="attemptBrandUpdate" class="btn btn-primary btn-lg" type="button">Update Brand Record</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onFileSelected(event) {
        ...
        fileReader.addEventListener('load', () => {
          this.brand.image = fileReader.result
        })
      ...
      attemptBrandUpdate() {
        this.$store.dispatch(IS_LOADING, true)
          .then(() => { 
            ...
            formData.append('is_active', this.brand.is_active ? 1 : 0);
            ...
            axios.post(`/managers/brands/${this.brandID}`, formData, {
              headers: {
      ...
      clearErrorStatusOnInput(fieldName) {
        if (this.brand[fieldName].length > 0) {
    ...
    created() {
      ...
      EventBus.$emit('active-menu-label-updated', 'edit brand');
