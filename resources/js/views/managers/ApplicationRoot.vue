<template>
  <div>
    <div class="main-wrapper">
      <page-header class="header" :pageHeader="`Manager`"></page-header>
      <page-sidemenu v-if="!isEmptyObject(loggedUser)" class="sidebar" :class="{ 'opened-menu-window': showMobileMenuOption }"></page-sidemenu>
...
<script>
  ...
  import PageSideMenu from '../../components/managers/LoggedUserSideMenu.vue';
