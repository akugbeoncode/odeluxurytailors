  ...
  <div class="content container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 col-8 text-right m-b-30">
            <!-- <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add_user"><i class="fa fa-plus"></i> New Transaction</a> -->
        </div>
    </div>
...
<script>
  export default {
    ...
    created() {
      EventBus.$emit('active-menu-label-updated', 'all tasks');
    }
  }
</script>
