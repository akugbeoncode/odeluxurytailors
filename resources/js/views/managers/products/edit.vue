    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <input @input="clearErrorStatusOnInput('name')" type="text" class="form-control floating text-center" v-model="product.name">
              </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <input @input="clearErrorStatusOnInput('generic_name')" type="text" class="form-control floating text-center" v-model="product.generic_name">
              </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <select @input="clearErrorStatusOnInput('category')" class="select form-control floating focused" v-model="product.category_id">
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <select @input="clearErrorStatusOnInput('brand')" class="select form-control floating focused" v-model="product.brand_id">
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <input type="number" @input="clearErrorStatusOnInput('unit_cost_price')" min="0" class="form-control floating focused" v-model="product.unit_cost_price">
              </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <input type="number" @input="clearErrorStatusOnInput('unit_selling_price')" min="0" class="form-control floating focused" v-model="product.unit_selling_price">
              </div>
            ...
            <div class="col-md-6 mb-3">
              <div class="form-group form-focus focused">
                ...
                <input type="number" @input="clearErrorStatusOnInput('quantity_alert')" min="0" class="form-control floating focused" v-model="product.quantity_alert">
              </div>
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group form-focus focused">
                ...
                <select @input="clearErrorStatusOnInput('product_unit')" class="select form-control floating focused" v-model="product.product_unit">
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group form-focus focused">
                ...
                <select @input="clearErrorStatusOnInput('sale_unit')" class="select form-control floating focused" v-model="product.sale_unit">
                  <option value="">Select Unit</option>
                  <option v-for="item in units" :key="item.id" :value="item.id">{{item.name}} ({{item.code}})</option>
                </select>
              </div>
            ...
            <div class="col-md-4 mb-3">
              <div class="form-group form-focus focused">
                ...
                <select @input="clearErrorStatusOnInput('purchase_unit')" class="select form-control floating focused" v-model="product.purchase_unit">
                  <option value="">Select Unit</option>
                  <option v-for="item in units" :key="item.id" :value="item.id">{{item.name}} ({{item.code}})</option>
                </select>
              </div>
            ...
            <div class="col-md-4 mt-2">
              <div class="form-group form-focus focused">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="checkbox" v-model="product.has_inventory"> Enable Inventory
                    </label>
                </div>                    
              </div>
              ...
              <div class="form-group form-focus focused">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="checkbox" v-model="product.is_active"> Enable Product
                    </label>
                </div>                    
              </div>
            </div>
            <div class="col-md-12 mb-3">
              <div class="form-group">
                  ...
                  <textarea @input="clearErrorStatusOnInput('product_meta')" class="form-control" v-model="product.product_meta"></textarea>
                </div>
            ...
            <div class="col-md-12 mb-3">
              <div class="form-group-ckeditor">
                ...
                <ckeditor class="form-control" v-model="product.product_details" style="padding: 0; height: inherit;"></ckeditor>
              </div>
        ...
        <div class="text-center m-t-20">
            <button v-if="!isLoading" @click.prevent="attemptUpdatingProductRecord" class="btn btn-primary btn-lg" type="button">Update Product</button>
...
<script>
  ...
  export default {
    ...
    created() {
      EventBus.$emit('active-menu-label-updated', 'edit-product');
