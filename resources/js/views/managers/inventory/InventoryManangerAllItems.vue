  ...
  <div class="content container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 col-8 text-right m-b-30">
            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add_user"><i class="fa fa-plus"></i> Add Inventory</a>
        </div>
    </div>
    <div class="row filter-row">
        <div class="col-sm-6 col-md-3">
            <div class="form-group form-focus focused">
                <label class="focus-label">Task ID</label>
...
<script>
  export default {
    name: 'InventoryManangerAllItems',
    ...
    created() {
      EventBus.$emit('active-menu-label-updated', 'inventory items');
    }
  }
</script>
