  ...
  <div class="content container-fluid">
    <div class="row">
        ...
        <div class="col-sm-8 col-8 text-right m-b-30">
            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#add_user"><i class="fa fa-plus"></i>Add Salary</a>
        </div>
    </div>
...
<script>
  export default {
    name: 'PayrollManagerEmployeeSalary',
    ...
    created() {
      EventBus.$emit('active-menu-label-updated', 'employee salary');
    }
  }
</script>
