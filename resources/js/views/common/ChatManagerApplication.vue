                ...
                <div class="chat-window">
                        ...
                        <div class="navbar">
                            <div class="user-details mr-auto">
                                <div class="pull-left user-img m-r-10">
                                    <a href="profile.html" title="Mike Litorus"><img :src="photo" alt="" class="w-40 rounded-circle"><span class="status online"></span></a>
                                </div>
                  ...
                  <button class="btn" type="button"><i class="fa fa-search"></i></button>
                            ...
                            <ul class="nav custom-menu">
                                <li class="nav-item">
                                    <a href="#chat_sidebar" class="nav-link task-chat profile-rightbar pull-right"><i class="fa fa-user" aria-hidden="true"></i></a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <div class="chat chat-left">
                                            <div class="chat-avatar">
                                                <a href="profile.html" class="avatar">
                                                    <img alt="John Doe" :src="photo" class="img-fluid rounded-circle">
                                                </a>
                                            </div>
                                            <div class="chat-body">
                                                <div class="chat-bubble">
                                                    ...
                                                    <div class="chat-content img-content">
                                                        <div class="chat-img-group clearfix">
                                                            ...
                                                            <a class="chat-img-attach" href="#">
                                                                <img width="182" height="137" alt="" :src="photo">
...
<button type="button" class="close" data-dismiss="modal">&times;</button>
    ...
    <div id="add_group" class="modal custom-modal fade">
<button type="button" class="close" data-dismiss="modal">&times;</button>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
