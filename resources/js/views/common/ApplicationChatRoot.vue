<template>
  <div>
    <div class="main-wrapper">
      ...
      <div class="page-wrapper" :class="{ 'strink-page-wrapper': showMobileMenuOption }" style="height: calc(100vh - 70px) !important; overflow: hidden; width: calc(100% - 250) !important;">
...
<script>
  ...
  import PageSideMenu from '../../components/common/ChatSideMenu.vue';
