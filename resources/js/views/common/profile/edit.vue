  ...
  <div class="content container-fluid">
    <div class="row">
        <div class="col-sm-4 col-4">
            <h4 class="page-title">Edit {{ capitalizeWordsInPhrase(loggedUser.lastname) }} {{ capitalizeWordsInPhrase(loggedUser.othernames) }}'s Profile</h4>
        </div>
    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
              ...
              <div class="row">
                  <div class="col-md-12">
                      <div class="profile-img-wrap">
                          <img class="inline-block" :src="loggedUser.photo" alt="user">
                      </div>
                          ...
                          <div class="row">
                              <div class="col-md-6 mb-3">
                                  <div class="form-group form-focus focused">
                                      ...
                                      <input @keypress="isLetter($event)" @input="clearErrorStatusOnInput('lastname')" type="text" class="form-control floating" v-model="loggedUserInstance.lastname">
                                  </div>
                              ...
                              <div class="col-md-6 mb-3">
                                  <div class="form-group form-focus focused">
                                      ...
                                      <input @keypress="isLetter($event)" @input="clearErrorStatusOnInput('othernames')" type="text" class="form-control floating" v-model="loggedUserInstance.othernames">
                                  </div>
                              ...
                              <div class="col-md-6 mb-3">
                                  <div class="form-group form-focus focused">
                                      ...
                                      <div class="cal-icon">
                                          <input @input="clearErrorStatusOnInput('dob')" class="form-control" type="date" :min="getMinDate()"  :max="getMaxDate()" v-model="loggedUserInstance.dob" disabled>
                                      </div>
                                  </div>
                              ...
                              <div class="col-md-6 mb-3">
                                  <div class="form-group form-focus select-focus">
                                      ...
                                      <select @change="clearErrorStatusOnInput('gender_id')" class="select form-control floating focused" v-model="loggedUserInstance.gender_id" disabled>
              ...
              <div class="row">
                  <div class="col-md-12 mb-3">
                      <div class="form-group form-focus focused">
                          ...
                          <textarea @input="clearErrorStatusOnInput('address')" type="text" class="form-control floating" v-model="loggedUserInstance.address"></textarea>
                      </div>
                  ...
                  <div class="col-md-4 mb-3">
                    <div class="form-group form-focus select-focus">
                      ...
                      <select @change="clearErrorStatusOnInput('country_id')" class="select form-control floating focused" v-model="loggedUserInstance.country_id" disabled>
                  ...
                  <div class="col-md-4 mb-3">
                    <div class="form-group form-focus select-focus">
                      ...
                      <select @change="clearErrorStatusOnInput('state_id')" class="select form-control floating focused" v-model="loggedUserInstance.state_id" disabled>
                  ...
                  <div class="col-md-4 mb-3">
                    <div class="form-group form-focus select-focus">
                      ...
                      <select @change="clearErrorStatusOnInput('city_id')" class="select form-control floating focused" v-model="loggedUserInstance.city_id" disabled>
                  ...
                  <div class="col-md-6 mb-3">
                      <div class="form-group form-focus focused">
                          ...
                          <input @input="clearErrorStatusOnInput('email')" type="email" class="form-control floating" v-model="loggedUserInstance.email" readonly disabled>
                      </div>
                  ...
                  <div class="col-md-6 mb-3">
                      <div class="form-group form-focus focused">
                          ...
                          <input @input="clearErrorStatusOnInput('phone')" @keypress="isPhoneNumber($event)" type="text" class="form-control floating" v-model="loggedUserInstance.phone">
                      </div>
            ...
            <div class="row">
              <div class="col-md-12 mb-3">
                <div class="form-group form-focus focused">
                  ...
                  <input @input="clearErrorStatusOnInput('employee_id')" type="text" class="form-control floating text-center" v-model="loggedUserInstance.employee_id" readonly disabled>
                </div>
              ...
              <div class="col-md-6 mb-3">
                <div class="form-group form-focus select-focus">
                  ...
                  <select @change="clearErrorStatusOnInput('role_id')" class="select form-control floating focused" v-model="loggedUserInstance.role_id">
              ...
              <div class="col-md-6 mb-3">
                <div class="form-group form-focus focused">
                  ...
                  <div class="cal-icon">
                      <input @input="clearErrorStatusOnInput('hire_date')" class="form-control" type="date" :min="getMinDate()"  :max="getTodayMaxDate()"  v-model="loggedUserInstance.hire_date" disabled>
                  </div>
                </div>
              ...
              <div class="col-md-12 mb-3">
                <div class="form-group form-focus select-focus">
                  ...
                  <select @input="clearErrorStatusOnInput('reports_to')" class="select form-control floating focused" v-model="loggedUserInstance.reports_to">
          ...
          <div class="text-center m-t-20">
            <button v-if="!isLoading" @click.prevent="attemptUpdatingLoggedUserRecord" class="btn btn-primary btn-lg" type="button">Update Record</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      updateStateOptions() {
        if (!this.loggedUserInstance.country_id) {
          this.countryStates = [];
        } else {
          this.countryStates = [];
          this.states.map(state => {
            if (state.country_id == this.loggedUserInstance.country_id) {
      ...
      updateCityOptions() {
        if (!this.loggedUserInstance.state_id) {
          this.stateCities = [];
        } else {
          this.stateCities = [];
          this.cities.map(city => {
            if (city.state_id == this.loggedUserInstance.state_id) {
      ...
      clearErrorStatusOnInput(fieldName) {
        if (this.loggedUserInstance[fieldName]){
          if (this.loggedUserInstance[fieldName].length > 0) {
      ...
      attemptUpdatingLoggedUserRecord() {
        this.$store.dispatch(IS_LOADING, true)
          .then(() => { 
            const formData = new FormData();

            formData.append('lastname', this.loggedUserInstance.lastname);
            formData.append('othernames', this.loggedUserInstance.othernames);
            formData.append('email', this.loggedUserInstance.email);
            formData.append('phone', this.loggedUserInstance.phone);
            formData.append('dob', this.loggedUserInstance.dob);
            formData.append('hire_date', this.loggedUserInstance.hire_date);
            formData.append('address', this.loggedUserInstance.address);
            formData.append('employee_id', this.loggedUserInstance.employee_id);
            formData.append('country_id', this.loggedUserInstance.country_id);
            formData.append('state_id', this.loggedUserInstance.state_id);
            formData.append('city_id', this.loggedUserInstance.city_id);
            formData.append('reports_to', this.loggedUserInstance.reports_to);
            formData.append('role_id', this.loggedUserInstance.role_id);
            formData.append('gender_id', this.loggedUserInstance.gender_id);
            formData.append("_method", "put");

            axios.defaults.headers.common['Authorization'] =  `${this.tokenType} ${this.token}`;
            axios.post(`/user-profile/${this.loggedUser.id}/update-logged-user-record`, formData, {
              headers: {
