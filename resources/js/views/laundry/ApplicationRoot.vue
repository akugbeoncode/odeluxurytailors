<template>
  <div>
    <div class="main-wrapper">
      <page-header class="header" :pageHeader="`Front Desk Services (Laundry)`"></page-header>
...
<script>
  ...
  import PageSideMenu from '../../components/laundry/LoggedUserSideMenu.vue';
  import DedicationSideMenu from '../../components/laundry/DedicatedSideMenu.vue';
